...
const Account = () => {
  ...
  return (
    <main className="max-w-[432px] mx-auto my-0 text-white py-[5px] mt-[30px]">
      <div
        className={`${router == '/account' && 'animate-fadeEffect'} flex flex-col justify-center items-center `}
      >
        <h3 className="text-white text-[35px] font-medium mb-1 mb-4">
          Your Account
        </h3>
        <Image src="/user_icon 1.png" width={130} height={130} alt="Avartar" />
        <p className="text-[#F076EB] text-[23px] font-medium mb-6 mt-5">
          @username
        </p>
        <section className="flex flex-col justify-center items-center w-[380px] h-[50px] bg-[#352F4D] rounded-[20px] mb-3">
          <div className="flex justify-between items-center w-full px-5">
            ...
            <p className="text-[13px] font-medium">
              Link X (twitter) connect your Account{' '}
            </p>
        ...
        <section className="flex flex-col justify-center items-center w-[380px] h-[111px] bg-[#352F4D] rounded-[20px] mb-[30px]">
          <p className="text-[12px] font-medium text-center px-8 mb-3">
            Please enter your ETH wallet address for MVH withdrawal ( It is
            specified only once and cannot be changed).
          </p>
          <div className="flex justify-between items-center w-full px-5">
            <Image
              src="/blockchain_ethereum_icon 1.png"
              width={27}
              height={45}
              alt="Twitter logo"
            />
        ...
        <p className="text-[#C0BEBE] text-[15px] font-medium text-center">
          For registration you receive
        </p>
        <p className="text-[#C0BEBE] text-[15px] font-medium text-center">
          the first MVH bonus to your balance.
        </p>
        <Footer />
      </div>
    </main>
